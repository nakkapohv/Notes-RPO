#Артефакт 
Улучшил код, а точнее убрал и объединил некоторые моменты (например сделал русскую кириллицу, убрал английскую), поменял размер окна, сделав его больше, сделал виселицу по середине нового окна, поменял цвет бэкграунда и т.д
