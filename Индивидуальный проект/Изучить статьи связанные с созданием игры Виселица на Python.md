...
Изучил статьи, попрактиковался дома на реальных рабочих кодах, в принципе код не сложный. Всё в целом мне понятно, скоро буду делать сырую версию игру. Вот пример кода:
